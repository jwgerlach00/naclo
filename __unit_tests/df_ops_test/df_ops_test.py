...
from __unit_tests.test_skeleton import BasicTest
...
class SDFToolsTests(BasicTest):
    ...
    def write_sdf_test(self):
        ...
        assert mol_conversion.smiles_from_mols(load_sdf.Molecule) == \
            mol_conversion.smiles_from_mols(self.sdf_df.Molecule)
